...
const Navbar = () => {
  return (
    ...
    <nav className="flex-[2]">
      <div className="h-screen bg-[#100e0e] text-[#F0EFE7] top-0 sticky">
        <div className="w-full flex flex-col items-end p-20 gap-2 text-left">
          <img
            src="./profile.JPG"
            alt="logo"
            className="border-animation w-28 sm:w-[28]"
          />
          <div>
            <h1 className="text-lg font-medium">Kushal Tamang</h1>
            <p className="text-[#949494]">Software Engineer</p>
          </div>
        </div>
      </div>
    </nav>
